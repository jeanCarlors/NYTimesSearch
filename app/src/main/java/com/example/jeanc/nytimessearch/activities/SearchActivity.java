...
import com.example.jeanc.nytimessearch.ArticleArrayAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public void onArticleSearch(View view) {
        ...
        String url = "http://developer.nytimes.com/article_search_v2.json";

        RequestParams params = new RequestParams();
        params.put("api-key", "1d7df76ee4bd4f8186c181ebd59b88f3");
        params.put("page", 0);
        params.put("q", query);
